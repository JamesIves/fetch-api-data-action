...
| `RETRY` | If you're working with an intermittent API you can toggle this option to `true`. Doing so will make the action try the request 4 times before failing.                                                                                                | `with` | **No**  |
