...
| `SAVE_LOCATION` | By default the save location of the JSON file is `fetch-api-data-action/data.json`, if you'd like to override it you can do so by specifying a new one with this variable.                                                                                                | `secrets / with` | **No**  |
